...
from models.query_models import VAE, Discriminator, GCN, GCNs, AGCN_FUN_A
...
if __name__=="__main__":
    ...
    matrix = [6, 6, 7, 7, 7, 7, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6]
    label = Data[img_gt]
    ...
    for cycle in range(CYCLE):
        ...
        gcn_module = AGCN_FUN_A(nfeat=features.shape[1],
    ...
    sio.savemat("data/AGCN_TRdataset_A.mat", {'GCN_TRdataset':GCN_dataset})
    sio.savemat("data/AGCN_TEdataset_A.mat", {'GCN_TEdataset':GCN_dataset2})