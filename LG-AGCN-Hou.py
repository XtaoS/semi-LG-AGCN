...
if __name__=="__main__":
    ...
    label_index = Con3Numpy('X_CNN_M_TR', 'X_CNN_M_TR')#替换为对应文件,修改'AGCN_TRdataset_M'
    ...
    sio.savemat("data/AGCN_TRdataset_HOU100_.mat", {'GCN_TRdataset': GCN_dataset})
    sio.savemat("data/AGCN_TEdataset_HOU100.mat", {'GCN_TEdataset': GCN_dataset2})
