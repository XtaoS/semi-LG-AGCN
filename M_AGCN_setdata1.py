...
if __name__=="__main__":
    ...
    # matrix = [12, 13, 8, 12, 12, 4, 12, 12, 12, 12, 12, 12, 5, 5, 7]
    label = Data[img_gt]
    ...
    sio.savemat("data/AGCN_TRdataset_M_900_hou2.mat", {'GCN_TRdataset': GCN_dataset})
    sio.savemat("data/AGCN_TEdataset_M_900_hou2.mat", {'GCN_TEdataset': GCN_dataset2})
