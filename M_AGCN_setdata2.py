...
parser.add_argument("-d","--dataset", type=str, default="WHU_Hi_LongKou",
                    help="")
...
if __name__=="__main__":
    ...
    matrix = [345, 83, 30, 632, 41, 118, 670, 71, 52]
    label = Data[img_gt]
    ...
    sio.savemat("data/AGCN_TRdataset_M_WHU.mat", {'GCN_TRdataset': GCN_dataset})
    sio.savemat("data/AGCN_TEdataset_M_WHU.mat", {'GCN_TEdataset': GCN_dataset2})